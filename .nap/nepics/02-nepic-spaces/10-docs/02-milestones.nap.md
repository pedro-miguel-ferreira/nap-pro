* nap v2 — milestones (sequenced for learning)
...
* M0 — design sprint (standalone HTML mocks)
  ...
  * learn
    ...
    * gutter with nepic icons — feels like Slack workspaces?
  * value: cheapest possible validation — hours, not weeks
  * why first
...
* M2 — real layout
  ...
  * build
    ...
    * content from filesystem (readdir), status from SQLite
  * learn
  ...
  * why after M1
    ...
    * SQLite is foundation, layout is surface
...
* M3 — session continuity
  ...
  * learn
    ...
    * define "enough context" — minimum for continuity
  ...
  * why after M2
    ...
    * persistence "nice to have" or "changes everything" — find out here
...
* M5 — board view
  ...
  * build
    * kanban toggle or full takeover (answered in M0)
